...
def change_wallpaper(file_path=None, restore=False):
    ...
    if original_wallpaper is None:
        key = RegOpenKeyEx(win32con.HKEY_CURRENT_USER,"Control Panel\\Desktop",0,win32con.KEY_READ)
        original_wallpaper, type = RegQueryValueEx(key, "Wallpaper")
...
if __name__ == '__main__':
    ...
    change_wallpaper('C:\\Users\\Test\\Pictures\\DeskTop01.png')
    ...
    change_wallpaper('C:\\Users\\Test\\Pictures\\DeskTop02.png')
